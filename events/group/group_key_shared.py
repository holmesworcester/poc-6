...
API functions:
    create(key_id, peer_id, peer_shared_id, recipient_peer_id, t_ms, db) -> str
    create_for_invite(key_id, peer_id, peer_shared_id, invite_id, t_ms, db) -> str
    project_event(key_shared_id, recorded_by, recorded_at, db) -> str | None
"""
