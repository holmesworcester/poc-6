...
def remove(peer_id: str, message_id: str, emoji: str, t_ms: int, db: Any) -> str:
    ...
    reaction_row = get_reaction(message_id, remover_user_id, emoji, peer_id, db)
    if not reaction_row:
        raise ValueError(
...
def get_reaction(message_id: str, reactor_id: str, emoji: str, recorded_by: str, db: Any) -> dict[str, Any] | None:
