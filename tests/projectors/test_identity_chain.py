"""Projector Tests: Identity Event Chain

Tests the projection of the identity event chain:
...
class TestNetworkProjector:
    """Tests for network event projector."""
...
class TestInviteProjector:
    """Tests for invite event projector."""
...
class TestUserProjector:
    """Tests for user event projector."""
...
class TestPeerSharedProjector:
    """Tests for peer_shared event projector."""
...
class TestInviteAcceptedProjector:
    """Tests for invite_accepted event projector."""
