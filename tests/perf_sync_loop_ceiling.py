...
def _apply_perf_tuning(fast: bool) -> None:
    ...
    os.environ.setdefault("TRANSPORT_FLOW_WINDOW", "4096")
    os.environ.setdefault("PERF_TICK_INTERVAL_MS", "10")
    ...
    jobs.set_frequency_multiplier(0.1)
...
def main() -> None:
    ...
    tick_interval_ms = int(os.getenv("PERF_TICK_INTERVAL_MS", str(tick_helper.TICK_INTERVAL_MS)))
    for i in range(args.max_rounds):
        t_ms = start_t_ms + i * tick_interval_ms
