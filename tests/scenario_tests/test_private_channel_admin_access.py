...
from events.identity import admin, invite, peer, user
...
def _run_scenario() -> None:
    ...
    print("  ✓ Charlie promoted to admin")
    ...
    if private_ch:
        ...
        if alice_is_member and bob_is_member and charlie_is_member:
            ...
            print(
                "     Expected all three to be members, got: "
                f"Alice={alice_is_member}, Bob={bob_is_member}, Charlie={charlie_is_member}"
            )
