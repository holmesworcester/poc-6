...
def wrap(plaintext_bytes: bytes, key_data: Any, db: Any) -> bytes:
    ...
    # Only log at debug level - this is called frequently during bulk transfers
    log.debug(f"crypto.wrap() key_id={key_id_b64[:20]}..., key_type={key_type}, size={len(plaintext_bytes)}B")
